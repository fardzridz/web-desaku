      ...
      <div className="space-y-12 md:space-y-24">
            ...
            <div className="relative h-12 md:h-16 rounded-full overflow-hidden flex bg-surface-container-highest select-none">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm md:text-base hidden sm:inline">Laki-laki</span>
                </div>
              </div>
              <div
              ...
              >
                 <div className="flex items-center gap-2">
                  <span className="text-sm md:text-base hidden sm:inline">Perempuan</span>
                  <span className="material-symbols-outlined text-lg md:text-xl">
                    woman
                  </span>
                </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            <div className="bg-surface-container-low p-6 md:p-8 rounded-3xl">
              ...
              <ul className="space-y-4">
                <li className="flex justify-between items-center bg-surface-container px-4 py-3 rounded-xl">
                  <span className="font-bold flex items-center gap-3"><span className="w-3 h-3 rounded-full bg-emerald-600"></span> Islam</span>
                ...
                <li className="flex justify-between items-center px-4 py-2 text-on-surface-variant">
                  <span className="font-medium flex items-center gap-3"><span className="w-3 h-3 rounded-full bg-blue-600"></span> Kristen</span>
                  <span className="font-bold">5</span>
                </li>
                <li className="flex justify-between items-center px-4 py-2 text-on-surface-variant">
                  <span className="font-medium flex items-center gap-3"><span className="w-3 h-3 rounded-full bg-red-600"></span> Katholik</span>
                  <span className="font-bold">3</span>
                </li>
                <li className="flex justify-between items-center px-4 py-2 text-on-surface-variant opacity-60">
                  <span className="font-medium flex items-center gap-3"><span className="w-3 h-3 rounded-full bg-stone-400"></span> Lainnya</span>
            ...
            <div className="bg-surface-container-low p-6 md:p-8 rounded-3xl">
              ...
              <ul className="space-y-4">
                <li className="flex justify-between items-center bg-surface-container px-4 py-3 rounded-xl">
                  <span className="font-bold flex items-center gap-3">Jawa</span>
                  <span className="font-black text-lg">6.912</span>
                </li>
                <li className="flex justify-between items-center px-4 py-2 text-on-surface-variant">
                  <span className="font-medium flex items-center gap-3">Madura</span>
              ...
              <div className="mt-8 p-4 bg-tertiary-container text-on-tertiary-container rounded-xl text-xs md:text-sm leading-relaxed border border-tertiary/20">
                Masyarakat hidup berdampingan dengan damai dan sangat didominasi oleh kebudayaan serta tradisi Jawa yang kental.
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10">
            <div className="lg:col-span-8 bg-surface-container-low p-6 md:p-10 rounded-3xl">
               <h3 className="text-lg md:text-xl font-bold font-headline mb-6">Pendidikan Dasar & Menengah</h3>
               <div className="space-y-5">
                  <div className="flex items-center gap-4">
                    <div className="w-16 md:w-24 text-xs md:text-sm font-bold text-on-surface-variant">SD / Sederajat</div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-16 md:w-24 text-xs md:text-sm font-bold text-on-surface-variant">SMP / Sederajat</div>
                    <div className="flex-1 bg-surface-container-highest h-6 rounded-full overflow-hidden">
                       <div className="bg-primary/80 h-full" style={{ width: "57%" }}></div>
                    </div>
                    <div className="w-12 text-right font-black">1.019</div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-16 md:w-24 text-xs md:text-sm font-bold text-on-surface-variant">SMA / Sederajat</div>
                    <div className="flex-1 bg-surface-container-highest h-6 rounded-full overflow-hidden">
                       <div className="bg-primary/60 h-full" style={{ width: "69%" }}></div>
                    </div>
               ...
               <div className="mt-10 pt-8 border-t border-outline-variant/30">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                      <h3 className="text-lg md:text-xl font-bold font-headline mb-2">Pendidikan Tinggi</h3>
                      <p className="text-xs md:text-sm text-on-surface-variant">Tren warga mengejar gelar Diploma dan Sarjana semakin meningkat.</p>
                    </div>
                    <div className="grid grid-cols-2 md:flex gap-4 md:gap-8">
                       <div className="bg-surface-container px-4 py-2 rounded-xl text-center">
                         <div className="font-extrabold text-xl text-primary">26</div>
                         <div className="text-[10px] font-bold tracking-widest text-on-surface-variant">D1 - D3</div>
                       </div>
                       <div className="bg-surface-container px-4 py-2 rounded-xl text-center">
                         <div className="font-extrabold text-xl text-primary">57</div>
                         <div className="text-[10px] font-bold tracking-widest text-on-surface-variant">STRATA 1</div>
                       </div>
                       <div className="bg-surface-container px-4 py-2 rounded-xl text-center">
                         <div className="font-extrabold text-xl text-primary">5</div>
                         <div className="text-[10px] font-bold tracking-widest text-on-surface-variant">STRATA 2</div>
                       </div>
                    </div>
                  </div>
               </div>
            ...
            <div className="lg:col-span-4 bg-tertiary text-on-tertiary p-6 md:p-10 rounded-3xl flex flex-col justify-center items-center text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="font-bold text-lg tracking-widest">PELAJAR AKTIF</p>
                <div className="w-12 h-1 bg-on-tertiary/30 mx-auto my-6 rounded-full"></div>
                <p className="text-sm opacity-90">
                  Generasi muda yang saat ini masih berstatus sebagai siswa atau mahasiswa aktif.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <p className="text-on-surface-variant mb-6 md:mb-10 max-w-3xl text-sm md:text-base leading-relaxed">
            Perekonomian Desa Wringinanom sangat ditopang oleh sektor agraris dan industri swasta. Mayoritas warga menggantungkan hidup pada hasil tani, namun daya serap tenaga kerja industri juga tinggi.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-surface-container p-6 md:p-8 rounded-3xl border-t-8 border-emerald-600">
               ...
               <div className="space-y-4">
                 <div className="flex justify-between items-center"><span className="text-on-surface-variant font-medium">Petani</span><span className="font-black text-lg">1.584</span></div>
                 <div className="flex justify-between items-center"><span className="text-on-surface-variant font-medium">Buruh Tani</span><span className="font-black text-lg">118</span></div>
                 <div className="flex justify-between items-center"><span className="text-on-surface-variant font-medium">Nelayan</span><span className="font-black text-lg">35</span></div>
               </div>
            </div>
            ...
            <div className="bg-surface-container p-6 md:p-8 rounded-3xl border-t-8 border-blue-600">
               ...
               <div className="space-y-4">
                 <div className="flex justify-between items-center"><span className="text-on-surface-variant font-medium">Karyawan Swasta</span><span className="font-black text-lg">637</span></div>
                 <div className="flex justify-between items-center"><span className="text-on-surface-variant font-medium">Buruh Harian Lepas</span><span className="font-black text-lg">193</span></div>
               </div>
            </div>

            <div className="bg-surface-container p-6 md:p-8 rounded-3xl border-t-8 border-stone-600 md:col-span-2 lg:col-span-1">
               <h3 className="font-bold font-headline text-lg mb-6 flex items-center gap-2">
                 <span className="material-symbols-outlined text-stone-600">badge</span> 
                 Profesi Lainnya
               </h3>
               <div className="grid grid-cols-2 gap-4">
                 <div>
                   <span className="block text-xs text-on-surface-variant uppercase font-bold tracking-widest mb-1 font-label">Sopir</span>
                   <span className="font-black text-lg">24</span>
                 </div>
                 <div>
                   <span className="block text-xs text-on-surface-variant uppercase font-bold tracking-widest mb-1 font-label">Perangkat</span>
                   <span className="font-black text-lg">17</span>
                 </div>
                 <div>
                   <span className="block text-xs text-on-surface-variant uppercase font-bold tracking-widest mb-1 font-label">Satpam</span>
                   <span className="font-black text-lg">13</span>
                 </div>
                 <div>
                   <span className="block text-xs text-on-surface-variant uppercase font-bold tracking-widest mb-1 font-label">PNS / TNI</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            <div className="space-y-6">
              <div className="bg-surface-container-low p-6 md:p-8 rounded-3xl border border-outline-variant/20 flex items-center gap-6">
                ...
                <div>
                   <h3 className="text-On-surface font-bold text-xl font-headline">Usia Produktif Bekerja</h3>
                   <p className="text-3xl font-black text-primary mt-1">2.554 <span className="text-sm font-normal text-on-surface-variant">Jiwa (18-56 th)</span></p>
                </div>
              </div>
              ...
              <div className="bg-surface-container-low p-6 md:p-8 rounded-3xl border border-outline-variant/20 flex items-center gap-6">
                ...
                <div>
                   <h3 className="text-On-surface font-bold text-xl font-headline">Warga Lanjut Usia (Lansia)</h3>
                   <p className="text-3xl font-black text-tertiary mt-1">734 <span className="text-sm font-normal text-on-surface-variant">Jiwa ({">"}56 th)</span></p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-secondary-container text-on-secondary-container p-6 md:p-8 rounded-3xl">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-xl font-bold font-headline mb-2">Sahabat Disabilitas</h3>
                  <p className="text-sm opacity-80">Dari total 27 Warga Berkebutuhan Khusus (19 Laki-laki, 8 Perempuan)</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                 <div className="bg-on-secondary-container/5 px-4 py-3 rounded-xl border border-on-secondary-container/10">
                   <span className="block text-xs uppercase font-bold tracking-widest mb-1 font-label opacity-80">Tuna Rungu</span>
                   <span className="font-black text-2xl">5</span>
                 </div>
                 <div className="bg-on-secondary-container/5 px-4 py-3 rounded-xl border border-on-secondary-container/10">
                   <span className="block text-xs uppercase font-bold tracking-widest mb-1 font-label opacity-80">Tuna Wicara</span>
                   <span className="font-black text-2xl">4</span>
                 </div>
                 <div className="bg-on-secondary-container/5 px-4 py-3 rounded-xl border border-on-secondary-container/10">
                   <span className="block text-xs uppercase font-bold tracking-widest mb-1 font-label opacity-80">Tuna Daksa</span>
                   <span className="font-black text-2xl">4</span>
                 </div>
                 <div className="bg-on-secondary-container/5 px-4 py-3 rounded-xl border border-on-secondary-container/10">
                   <span className="block text-xs uppercase font-bold tracking-widest mb-1 font-label opacity-80">Lainnya</span>
